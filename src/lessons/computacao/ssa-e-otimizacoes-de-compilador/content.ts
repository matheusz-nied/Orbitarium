...
export const ssaEOtimizacoesDeCompiladorContent: LessonContent = {
    ...
    s(
      ...
      [
        ...
        },
        {
          ...
          formula: "B esta na frontier de A se A domina um predecessor de B, mas A nao domina estritamente B.",
        },
      ],
    ),
    s(
  ...
  glossary: [
    ...
    g(
      "Dominance frontier",
      "Conjunto de blocos B tais que A domina um predecessor de B, mas A nao domina estritamente B; e nesses pontos que phi costuma ser necessario.",
    ),
