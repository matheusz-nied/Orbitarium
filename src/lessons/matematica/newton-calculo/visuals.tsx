...
export const visuals = {
  "newton-motion": NewtonMotionVisual,
  "static-dynamic": StaticDynamicVisual,
  "secant-tangent": SecantTangentVisual,
  "area-under-curve": AreaUnderCurveVisual,
  "derivative-integral-flow": DerivativeIntegralFlowVisual,
  "fluxions-flow": FluxionsFlowVisual,
  "falling-orbit": FallingOrbitVisual,
  "newton-leibniz": NewtonLeibnizVisual,
